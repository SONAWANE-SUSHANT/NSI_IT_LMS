    ...
    <div className="space-y-6 pb-12 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-white shadow-md hover:shadow-lg transition-all cursor-pointer self-start sm:self-auto"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-xs">
          <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Total Notices</span>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-xs">
          <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Archived</span>
          <div className="text-2xl font-black text-slate-600 mt-1">{archivedCount}</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-xs flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <button
            ...
            onClick={loadData}
            title="Refresh"
            className="p-2 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-100 transition-colors ml-auto cursor-pointer shrink-0"
          >
                  ...
                  return (
                    <tr key={ann.id} className="hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="py-4 px-5 max-w-xs sm:max-w-md">
                        <div className="font-bold text-slate-900 leading-snug">{ann.title}</div>
                        <p className="text-slate-500 text-[11px] line-clamp-2 mt-0.5 whitespace-pre-line">
                          {ann.message}
                        </p>
                      </td>
                      ...
                      <td className="py-4 px-4 whitespace-nowrap">
                        ...
                        {isCourse && (
                          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md text-[11px] font-bold bg-indigo-50 text-indigo-700 border border-indigo-200">
                            ...
                            <span>Course: {ann.course?.code || ann.course?.name}</span>
                          </span>
                        )}
                        {isBatch && (
                          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md text-[11px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200">
                            ...
                            <span>Batch: {ann.batch?.name}</span>
                          </span>
                        )}
                      </td>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-fadeIn">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 shadow-2xl border border-slate-200/90 relative max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
