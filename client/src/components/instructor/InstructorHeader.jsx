          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5 pl-3 border-l border-slate-200">
              ...
              >
                ...
                {!user?.photo && (
                  <div className="w-8 h-8 rounded-full bg-teal-100 text-teal-800 flex items-center justify-center font-bold text-xs border border-teal-200 shrink-0">
                    {user?.first_name ? user.first_name[0].toUpperCase() : <User className="w-4 h-4" />}
                  </div>
                )}
                <div className="hidden lg:block text-left">
                  <p className="text-xs font-semibold text-slate-800 leading-tight group-hover:text-teal-700 transition-colors">{fullName}</p>
