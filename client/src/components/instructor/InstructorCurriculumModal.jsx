      ...
      <div className="bg-white rounded-2xl max-w-3xl w-full shadow-2xl border border-slate-100 overflow-hidden my-8 flex flex-col max-h-[85vh] animate-in fade-in zoom-in-95 duration-150">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-xs text-slate-400 mt-1 max-w-sm mx-auto">
                Modules and sessions can be set up to organize the course curriculum.
              </p>
            </div>
          ) : (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-0.5 text-[11px] text-slate-500 font-medium">
                          ...
                          <span>&bull;</span>
                          <span>{lectures.length} Sessions / Lectures</span>
                        </div>
                      </div>
                    </div>
                                ...
                                <div className="mt-3 pt-2.5 border-t border-slate-100 flex flex-wrap gap-2">
                                  {lec.notes.map((note) => (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noreferrer"
                                      className="inline-flex items-center gap-1 text-[11px] font-medium text-teal-700 bg-teal-50 px-2.5 py-1 rounded-md border border-teal-200 hover:bg-teal-100 transition-colors"
                                    >
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between">
          <button
            onClick={() => {
              onClose();
              if (onScheduleSession) onScheduleSession(batch);
            }}
          ...
          >
            <Video className="w-3.5 h-3.5" />
            <span>Schedule Session for Batch</span>
          </button>
          <button
            onClick={onClose}
